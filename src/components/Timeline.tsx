...
const timelineItemArray: Array<{
  ...
  },
  {
    ...
    description: `This was my first research experience that I had. This opportunity was given through UMass Lowell's Immersive Scholars Program. 
      ...
      create plots to analyze the data we found from the different algorithms. I was also able to be part of a paper submission to the Privacy 
  ...
  },
  {
    ...
    in Agile, and with a dedicated team. I also learned a lot about the healthcare industry and how software is used in it. I was able to work in the Care Collaboration division whose 
  ...
  },
  {
    ...
    research was about the effects of breaks and rest on productivity when doing a task. I used Angular, Node.js, and MySQL to build this project. I 
  ...
  },
  {
    ...
    collect over 500,000 tweets, filtered and aggregated them for us to analyze.`,
    orientation: TimelineItemOrientation.LEFT,
    imgSrc: 'X_logo.svg'
  },
  {
    ...
    description: `This is my second corporate experience and my first time working in the defense contracting industry. This was a very interesting environment because 
    of the heightened security and the type of work that was being done. I was part of the web development team and I was able to work on both the internal website for the lab, and the external 
  ...
  },
  {
    ...
    repository but was still in the same Care Collaboration division of the company. I utilized React and Nodejs to build features that would help internal care managers and care coordinators 
    work with their patients and streamline their workflow. `,
    orientation: TimelineItemOrientation.LEFT,
    imgSrc: 'athenahealth-icon.png',
    linkText: 'View Athenahealth website',
    linkHref: 'https://www.athenahealth.com/'
